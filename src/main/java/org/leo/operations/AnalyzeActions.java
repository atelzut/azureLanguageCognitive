...
public class AnalyzeActions implements AzureOperation {
    ...
    public static JSONObject analize(List<TextDocumentInput> documents) {
        ...
        }).flatMap(analyzeActionsResultPagedFlux -> analyzeActionsResultPagedFlux.byPage()).subscribe(perPage -> processAnalyzeActionsResult(perPage, results), ex -> System.out.println("Error listing pages: " + ex.getMessage()), () -> System.out.println("Successfully listed all pages"));
